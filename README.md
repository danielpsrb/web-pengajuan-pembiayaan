...
Web Prototipe Pengajuan dan Pembiayaan berbasis **Laravel 13** + **Tailwind CSS** untuk mencatat, memantau,
...
5. **Validasi & business rules**:
   - Pendapatan bulanan nasabah **< Rp 1.000.000** → pengajuan ditolak sistem dengan pesan
     _"Nasabah belum dapat mengajukan pinjaman"_.
...
- **MySQL** sebagai database relational
...
2. Data pengajuan baru akan muncul di **Tabel Pengajuan** dengan status _Menunggu_.
...
5. Jika nominal pengajuan melebihi Rp 200.000.000 dan tombol "Setujui" ditekan, sistem akan
   ...
   status tetap _Menunggu_ sehingga pengajuan bisa ditolak manual bila diperlukan).
